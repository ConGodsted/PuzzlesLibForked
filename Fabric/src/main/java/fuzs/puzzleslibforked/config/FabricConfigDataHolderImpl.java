package fuzs.puzzleslibforked.config;

import com.google.common.collect.ImmutableList;
import com.mojang.datafixers.util.Either;
import com.mojang.datafixers.util.Unit;
import fuzs.puzzleslibforked.config.annotation.AnnotatedConfigBuilder;
import fuzs.puzzleslibforked.config.core.FabricConfigBuilderWrapper;
...
/**
 * implementation on Fabric, identical to Forge class (needs to exist twice as it cannot exist in the common subproject)
 * @param <T> config type
 */
