package fuzs.puzzleslibforked.config.core;
 ...
 */
public record ForgeConfigBuilderWrapper(ForgeConfigSpec.Builder builder) implements AbstractConfigBuilder {
...
//    }
    ...
    private static <T> AbstractConfigValue<T> wrap(ForgeConfigSpec.ConfigValue<T> value) {
        return new ForgeConfigValueWrapper<>(value);
    }
}
